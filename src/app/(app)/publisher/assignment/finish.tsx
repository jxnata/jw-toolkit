...
const foundOptions = ['Encontrou o surdo', 'Encontrou um familiar', 'Outro']
						...
						<View className="w-full gap-3">
							{foundOptions.map((option) => (
								<TouchableOpacity
									...
									className="w-full items-center rounded-xl bg-primary-600 py-5">
									<Text className="font-bold text-[15px] text-white">{option}</Text>
								</TouchableOpacity>
							))}
						</View>
					</View>
